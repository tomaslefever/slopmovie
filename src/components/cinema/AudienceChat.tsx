...
export const AudienceChat: React.FC<AudienceChatProps> = ({
  ...
  return (
    <aside className="absolute inset-y-0 right-0 z-50 w-[85%] max-w-xs md:static md:z-30 md:w-80 lg:w-96 h-full bg-[#08090d]/95 border-l border-white/10 flex flex-col md:backdrop-blur-2xl transition-all duration-300 select-none shadow-2xl md:shadow-none">
      {/* Chat Header */}
