...
export const CINEMATIQUE_AESTHETIC_PRESETS = [
  "Anamorphic 35mm Panavision C-Series, Tech-Noir cyan-amber grading, rain-slicked obsidian asphalt, practical neon reflections, volumetric steam shafts, Kodak Vision3 500T grain",
  "70mm Ultra Panavision, Dark Gothic Fantasy, Caravaggio chiaroscuro, single candlelit key, smoldering runic embers, deep velvety shadows, Cooke S4 organic warmth",
  "IMAX 65mm Cosmic Odyssey, deep void blacks, pulsing nebula chromatic aberration, cockpit HUD glare, clinical Zeiss Master Prime sharpness, anamorphic horizontal flares",
  "Super 35mm Techniscope 2-perf, Post-Apocalyptic Solarpunk, sun-bleached ochre and rusted iron, blinding golden hour sunbursts, heat haze shimmer, gritty silver-halide texture",
  "35mm Vintage Monochrome, Steampunk Alchemy, heavy gaslight sepia, gobo shadows through brass gears, copper steam plumes, high contrast Kodak Double-X black and white",
  ...
  "Zhang Yimou Silkpunk Wuxia, sweeping Technocrane aerial arc, trailing crimson silk robes, bamboo mist at dawn, painterly Kodachrome palette, 240fps slow-motion water droplets",
  "Michael Mann Blue Hour Neo-Noir, 20 minutes post-sunset cobalt twilight, warm sodium streetlight bounce, high-ISO Alexa sensor with Cooke S7 roll-off, urban melancholy",
  "Alejandro Jodorowsky Acid Western, surreal psychedelic desert horizon, sun-baked bleached skulls, mirage heat distortion, 16mm grain, Technicolor 3-strip saturated sky",
  "Charles Laughton Southern Gothic, rotting plantation architecture draped in Spanish moss, dreamlike river reflections, high-contrast chiaroscuro with moonlight rim",
  "Abyssal Deep-Sea Thriller, bio-luminescent cyan and emerald organism glow, murky oceanic pressure haze, macro particle scatter in submersible halogen beams",
  "Cyber-Gothic Vatican Espionage, neo-baroque stained-glass cathedral arches, flickering beeswax candlelight mixing with glowing fiber-optic server racks",
  ...
  "David Fincher Forensic Precision, locked-off camera with surgical tracking, sickly desaturated green-amber color grade, hard overhead fluorescent light, zero handheld shake",
  ...
  "Christopher Doyle Kinetic Street Camera, Dutch angle handheld, saturated yellow-green practical tubes, motion blur on fast turns, gritty urban intimacy",
  ...
  "Park Chan-wook Baroque Revenge, opulent wallpaper patterns, dynamic split-screen composition, extreme overhead tatami shot, razor-sharp monochrome grading"
];
